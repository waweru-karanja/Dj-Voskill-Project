{{-- <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background: rgb(224, 210, 13)">
  <div class="container">
...
{{-- <header class="header sticky-top" style="background: royalblue">
  <div class="header-inner">
    <div class="container-fluid px-lg-5">
      <nav class="navbar navbar-expand-lg my-navbar">
        <a class="navbar-brand" href="{{route ('index') }}">
          <span class="logo">
            <img src="dist/frontend/images/DjVoskillLogo.jpg" alt="Dj Voskill" class="img-fluid" style="width:30px; margin:-3px 0px 0px 0px;">Dj Voskill
           
          </span>
        </a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon">
            <i class="fa fa-bars" style="margin:5px 0px 0px 0px;"></i>
          </span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav m-auto">
