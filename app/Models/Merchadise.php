...
class Merchadise extends Model
{
    ...
    protected $fillable = ['merchcat_id','merch_name','merch_price','merch_code','merch_image','merch_details','Product_status','product_discount'];
    ...
    public static function getdiscountedattrprice($product_id,$productattr_size ){
        ...
        return array ('merch_price'=>$proattrprice['productattr_price'],'final_price'=>$final_price,'discount'=>$discount);
    }
